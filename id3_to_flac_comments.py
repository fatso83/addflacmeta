...
def id3_to_flac(filename):
	...
	# Comment this out to not delete ID3 info 
	audio.delete()
...
if __name__ == '__main__':
	if len(sys.argv) < 2:
		print "Usage: ",sys.argv[0], "filename.flac",\
				"\nWill convert any id3 info in the file and add it as FLAC meta information"
		exit(1)

	filename=sys.argv[1]
	id3_to_flac(filename)
